...
const footer = () => {
  return (
    <div className='flex flex-col w-full lg:flex-row bg-[#2A2D4B] rounded-t-3xl gap-y-10 items-center p-4 lg:justify-around  md:rounded-3xl lg:rounded-3xl lg:px-11 lg:py-8'>
       <div className='grid grid-cols-3 gap-10 gap-x-[120px] text-white'>
        ...
        <div className='flex lg:w-[270px] lg:gap-x-20 md:justify-evenly lg:justify-between'>
          ...
          <span className="[&>svg]:h-10 [&>svg]:w-10 [&>svg]:fill-[#7289da]">
          ...
          <span className="[&>svg]:h-10 [&>svg]:w-10 [&>svg]:fill-[#c13584]">
